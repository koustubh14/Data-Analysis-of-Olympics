...
if user_menu == 'Athlete wise Analysis':
    ...
    valid_data = []
    labels = []
    for data, label in zip([x1, x2, x3, x4],
    ...
    if valid_data:
        ...
        st.warning("Insufficient age data to create distribution plot")
    ...
    if x:
        ...
        st.warning("Insufficient data to create age distribution plot for gold medalists")
    ...
    if not temp_df.empty:
        ...
        st.warning("No athlete data available for selected sport")
